...
// Fetches the default resource server interface server-config section. Its readOnly layer being set
// means the default is configured declaratively and cannot be changed at runtime.
export default function useGetDefaultResourceServer(): UseQueryResult<DefaultResourceServerConfigResponse> {
  ...
  return useQuery<DefaultResourceServerConfigResponse>({
    queryKey: [ResourceServerQueryKeys.SERVER_CONFIG, ResourceServerQueryKeys.DEFAULT_RESOURCE_SERVER_INTERFACE],
