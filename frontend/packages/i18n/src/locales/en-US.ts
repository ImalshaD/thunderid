...
const translations = {
  ...
  resourceServers: {
    ...
    'edit.tab.interfaces': 'Interfaces',
    ...
    'edit.unsavedChanges': 'You have unsaved changes.',
    'edit.interfaces.title': 'Interfaces',
    ...
    'edit.interfaces.add': 'Add interface',
    'edit.interfaces.default': 'Default',
    'edit.interfaces.empty':
      'No interfaces yet. This resource server defines permissions but cannot receive tokens until an interface is added.',
    'edit.interfaces.loadError': 'Failed to load interfaces.',
    'edit.interfaces.added': 'Interface added.',
    'edit.interfaces.updated': 'Interface updated.',
    'edit.interfaces.deleted': 'Interface deleted.',
    'edit.interfaces.saveError': 'Failed to save the interface.',
    'edit.interfaces.deleteError': 'Failed to delete the interface.',
    'edit.interfaces.deleteTitle': 'Delete interface',
    'edit.interfaces.deleteWarning': 'Clients can no longer request tokens for this audience.',
    'edit.interfaces.deleteDescription': 'Tokens already issued for this audience stay valid until they expire.',
    'edit.interfaces.deleteDefaultBlocked':
      'This interface is the default resource server. Change the default before deleting it.',
    'edit.interfaces.dialog.addTitle': 'Add interface',
    'edit.interfaces.dialog.editTitle': 'Edit interface',
    'edit.interfaces.dialog.description':
      'The identifier is the audience of access tokens issued for this interface, and must be unique across the deployment.',
    'edit.interfaces.dialog.typeLabel': 'Type',
    'edit.interfaces.dialog.identifierLabel': 'Identifier (Audience)',
    'edit.interfaces.dialog.identifierHint':
      'Clients pass this value in the resource parameter to request tokens for this interface.',
    'edit.interfaces.dialog.placeholder': 'https://api.example.com',
    'edit.interfaces.dialog.placeholderMcp': 'https://mcp.example.com',
    'default.title': 'Default resource server',
    'default.description': 'Access tokens requested without a resource parameter are issued for this interface.',
    'default.empty':
      'No default configured. Requests that ask for permissions without a resource parameter are rejected.',
    'default.select': 'Select',
    'default.declarative': 'Declarative',
    'default.declarativeHint': 'Configured through declarative configuration and cannot be changed here.',
    'default.unresolvedName': 'Resource server outside the current page',
    'default.saved': 'Default resource server updated.',
    'default.cleared': 'Default resource server cleared.',
    'default.saveError': 'Failed to update the default resource server.',
    'default.dialog.title': 'Default resource server',
    ...
    'default.dialog.resourceServerLabel': 'Resource server',
    'default.dialog.interfaceLabel': 'Interface',
    'default.dialog.noneSelectable':
      'No resource server has an interface yet. Add an interface to a resource server before setting a default.',
    'default.dialog.clear': 'Clear default',
